...
const PortalLogins = ({ practiceId }) => {
  ...
  useEffect(() => {
    practicesCRUD
      .getPracticePortalLoginDetails(practiceId)
      .then((data) => {
  ...
  const saveDetail = () => {
    ...
    practicesCRUD
      .updatePracticePortalLoginDetails(practiceId, sendDeletedPortalLoginIDS)
      .then((data) => {
        setPortalLoginData(data);
      })
      .catch((err) => {
